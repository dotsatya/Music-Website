...
Array.from(document.getElementsByClassName('playlistplay')).forEach((e) => {
  e.addEventListener('click', (el) => {
    index = el.target.id;
    // console.log(index);
    music.src = `audio/Alan_Walker/${index}.mp3`;
    ...
    master_play.classList.add('bi-pause-fill');
    //download music
    download_music.href = `audio/Alan_Walker/${index}.mp3`;
...
previous.addEventListener('click', () => {
  ...
  music.src = `audio/Alan_Walker/${index}.mp3`;
  // poster_play_side.src = `img/Alan_Walker/${index}.jpg`;
  music.play();
  wave.classList.add('active1');
